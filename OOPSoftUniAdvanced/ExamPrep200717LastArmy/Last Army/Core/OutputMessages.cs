...
public static class OutputMessages
{
    ...
    public const string SoldierCannotBeEquipped = "There is no weapon for {0} {1}!";
    public const string Results = "Results:";
    public const string SuccessfullMissionsCount = "Successfull missions -{0}";
    public const string FaildMissionCount = "Faild missions - {0}";
